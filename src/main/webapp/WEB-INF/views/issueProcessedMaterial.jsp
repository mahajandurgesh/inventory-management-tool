        ...
        <div class="row mt-5">
            <div class="col-12">
                <div class="text-center">
                    <h2>Issue Processed Items</h2>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-12">
                <form action="decrementProcessedMaterial" method="post">
                    <div class="form-row">
                        <div class="form-group col-12">
                            <label for="quantity">Quantity</label>
                            <input type="number" class="form-control" id="quantity" name="quantity" placeholder="Quantity" min="1" max="<%=request.getAttribute("maxQuantity")%>" required>       
                    ...
                    <div class="form-row">
                        <div class="form-group col-12">
                            ...
                            <input type="text" class="form-control" id="issuer" name="issuer" placeholder="Issuer" required>                                
                        </div>
                    </div>
                    <div class="text-center">
